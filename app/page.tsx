    ...
    <div className="min-h-screen bg-white font-serif">
      ...
      <header className="flex justify-between items-center px-6 md:px-16 lg:px-32 py-4 md:py-6">
        ...
        <nav className="flex gap-8">
          ...
          <Link href="/blog" className="text-lg hover:opacity-70 transition-opacity">
            blog
          </Link>
          <Link
      ...
      <main className="px-6 md:px-16 lg:px-32 py-8 md:py-12 mx-4 md:mx-20">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
            {/* Featured Project 1 */}
            <Link href="/blog/48-hour-cancer-binder" className="group block">
            ...
            {/* Featured Project 2 */}
            <Link href="/blog/anatomy-of-boltzgen" className="group block">
              <div className="transition-all duration-300 ease-out md:group-hover:-translate-y-1 md:group-hover:shadow-lg md:group-hover:shadow-gray-200/50 p-4 -m-4 rounded-lg text-center lg:text-left">
                <div className="mb-4 flex justify-center lg:justify-start">
                  <Image
            ...
            {/* Featured Project 3 */}
            <Link href="/blog/pnmlr" className="group block">
              <div className="transition-all duration-300 ease-out md:group-hover:-translate-y-1 md:group-hover:shadow-lg md:group-hover:shadow-gray-200/50 p-4 -m-4 rounded-lg text-center lg:text-left">
                <div className="mb-4 flex justify-center lg:justify-start">
                  <Image
